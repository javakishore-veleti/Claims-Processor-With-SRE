...
@Service
@ConditionalOnProperty(name = "claims.features.search.enabled", havingValue = "true")
@Slf4j
public class ElasticsearchIndexService implements SearchIndexService {
    ...
    public ElasticsearchIndexService(
            @Value("${claims.features.search.elasticsearch-url:http://localhost:9200}") String esUrl) {
